...
class RoleController extends Controller
{
    ...
    public function destroy(\App\Models\Roles $role)
    {
        if ($role->exists) {
            $role->delete();
            return redirect()->route('roles.index')->with('flash.success', 'eliminado exitosamente.');
        }
        return redirect()->route('roles.index')->with('flash.error', 'No se pudo eliminar el administrativo.');
    }
}
