                ...
                <form @submit.prevent="submit">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 pb-8">
                        ...
                        <div class="w-full">
                            ...
                            <input
                                v-model="form.cliente.nit"
                                type="text" name="nit" id="nit"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Registra un nit" required="">
                            <div v-if="form.errors['cliente.nit']" class="text-red-600 mt-2">
                                {{ form.errors['cliente.nit'] }}
                            </div>
                        </div>
                        <div class="w-full">
                            ...
                            <input
                                v-model="form.cliente.razon_social"
                                type="text" name="razon_social" id="razon_social"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Registra un razon_social" required="">
                            <div v-if="form.errors['cliente.razonSocial']" class="text-red-600 mt-2">
                                {{ form.errors['cliente.razonSocial'] }}
                            </div>
                        </div>
                        <div class="w-full">
