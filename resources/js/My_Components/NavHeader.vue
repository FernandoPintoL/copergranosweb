            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a class="flex ml-2 md:mr-24">
                        <img src="/assets/images/copergranos.jpeg" class="h-8 mr-3" alt="FlowBite Logo"/>
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">COPERGRANOS</span>
                    </a>
                </div>
                        ...
                        <div
                            ...
                            <ul class="py-1" role="none">
                                ...
                                <li>
                                    ...
                                    <form @submit.prevent="logout" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
